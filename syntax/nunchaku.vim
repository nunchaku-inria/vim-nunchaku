...
syn match       nunBuiltin     "\<unique\>"
syn match       nunBuiltin     "\<unique_unsafe\>"
...
syn match       nunConnective  "->"
syn match       nunConnective  "=>"
syn match       nunConnective  "\<as\>"
syn match       nunConnective  "\<fun\>"
syn match       nunConnective  "\<let\>"
syn match       nunConnective  "\<match\>"
syn match       nunConnective  "\<with\>"
syn match       nunConnective  "\<end\>"
syn match       nunConnective  "\<in\>"
syn match       nunConnective  "\<and\>"
syn match       nunConnective  "\<asserting\>"
syn match       nunConnective  "&&"
syn match       nunConnective  "||"
syn match       nunConnective  "|"
syn match       nunConnective  "\~"
